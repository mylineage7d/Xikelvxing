...
//    self.scrollV.userInteractionEnabled = YES;
    ...
    self.content.frame = CGRectMake(self.headImage.frame.origin.x, CGRectGetMaxY(self.heartButton.frame), Max_Width - 20, 16);
    ...
    self.scrollLikeV.frame = CGRectMake(Left_Offset(10), CGRectGetMaxY(self.content.frame) + Top_Offset(10), Max_Width - 20, Button_Size);
    self.scrollLikeV.userInteractionEnabled = YES;
    self.scrollLikeV.showsHorizontalScrollIndicator = NO;
    
    self.bottomV.frame = CGRectMake(0, Max_Height - 40 - 64, Max_Width, 40);
    self.bottomV.backgroundColor = [UIColor whiteColor];
    
    self.bottomTextField.frame = CGRectMake(Left_Offset(10), Max_Height - 40 - 64 + 3, (Max_Width - 25) / 5 * 4, 30);
...
//    self.bottomTextView.frame = CGRectMake(Left_Offset(10), Max_Height - 40 - 64 + 3, (Max_Width - 25) / 5 * 4, 30);
//    self.bottomTextView.font = [UIFont systemFontOfSize:17];
    
    self.bottomButton.frame = CGRectMake(Max_Width - (Max_Width - 25) / 5 - Right_Offset(10), Max_Height - 40 - 64 + 5, (Max_Width - 25) / 5, 30);
