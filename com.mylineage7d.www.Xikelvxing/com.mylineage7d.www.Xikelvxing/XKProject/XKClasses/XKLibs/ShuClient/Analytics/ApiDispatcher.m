 ...
 */
- (ApiDispatcherResult*) dispatch:(AbstractAnalyticsApiCall*)apiCall projectKey:(NSString *)projectKey projectID:(NSString *)projectID
{
    ...
    [request setHTTPBody:[[NSString stringWithFormat:@"[%@]",[apiCall payload]] dataUsingEncoding:NSUTF8StringEncoding]];
...
{
    static NSString *apiServer = @"https://api.shushuo.com";
