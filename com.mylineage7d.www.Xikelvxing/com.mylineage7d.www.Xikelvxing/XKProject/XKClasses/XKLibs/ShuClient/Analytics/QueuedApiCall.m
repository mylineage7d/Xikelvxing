 ...
 */
- (instancetype) initWithId:(int)callId endpoint:(NSString *)endpoint payload:(NSString *)payload projectKey:(NSString *)projectKey projectID:(NSString *)projectID
{
    if (self = [self initAbstract:nil projectID:projectID projectKey:projectKey])
    {
        self.callId = callId;
