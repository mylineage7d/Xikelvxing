 ...
 */
- (instancetype) initWithDataAndTimestamp:(NSString *)actor action:(NSString *)action properties:(NSDictionary *)properties projectID:(NSString *)projectID projectKey:(NSString *)projectKey timestamp:(NSDate *)timestamp

{
    if (self = [[self init] initAbstract:actor projectID:projectID projectKey:projectKey])
    {
        self->_action = action;
 ...
 * @param writeKey			The write key to use for this API call.
 */
- (instancetype) initWithData:(NSString *)actor action:(NSString *)action properties:(NSDictionary *)properties projectID:(NSString *)projectID projectKey:(NSString *)projectKey
{
    return [self initWithDataAndTimestamp:actor action:action properties:properties projectID:projectID projectKey:projectKey timestamp:[[NSDate alloc] init]];
...
{
    static NSString *endpoint = @"/events";
    return endpoint;
}
