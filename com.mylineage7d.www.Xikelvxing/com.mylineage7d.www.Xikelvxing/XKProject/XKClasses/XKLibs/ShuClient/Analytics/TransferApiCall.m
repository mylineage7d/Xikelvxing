 ...
 */
- (instancetype) initWithData:(NSString *)oldActor newActor:(NSString *)newActor projectKey:(NSString *)projectKey projectID:(NSString *)projectID;
{
    if (self = [[self init] initAbstract:oldActor projectID:projectID projectKey:projectKey])
    {
