...
#define WMTitleColorSelected [UIColor colorWithRed:223.0/255.0 green:45.0/255.0 blue:148/255.0 alpha:1]
#define WMTitleColorNormal   [UIColor colorWithRed:0 green:0 blue:0 alpha:1]
//  导航菜单栏的背景颜色
#define WMMenuBGColor        [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1]
...
//  导航菜单栏的高度
static CGFloat const WMMenuHeight        = 64.0f;
//  导航菜单栏每个item的宽度
