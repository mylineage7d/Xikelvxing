...
@interface WMPageController () <WMMenuViewDelegate, UIScrollViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate> {
    CGFloat _viewHeight;
    CGFloat _viewWidth;
    CGFloat _viewX;
    CGFloat _viewY;
...
#pragma mark ---- 设置上传 ----
    ...
    [menuView.scrollView addSubview:menuView.cameraButton];
